...
std::pair<double, double> GeometryManager::compute_x_range(Parameters & in_params) {
...
std::pair<double, double> GeometryManager::compute_y_range(Parameters & in_params) {
...
std::pair<double, double> GeometryManager::compute_z_range(Parameters & in_params) {
...
bool GeometryManager::math_coordinate_in_waveguide(dealii::Point<3, double> in_position) const {
