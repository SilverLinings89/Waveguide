...
void ParameterReader::declare_parameters()
{
	...
	prm.enter_subsection("Solver");
		...
		prm.declare_entry("Preconditioner", "Amesos_Lapack", Patterns::Selection("Amesos_Lapack|Amesos_Scalapack|Amesos_Klu|Amesos_Umfpack|Amesos_Pardiso|Amesos_Taucs|Amesos_Superlu|Amesos_Superludist|Amesos_Dscpack|Amesos_Mumps"), "Which preconditioner to use");
