...
class Sector {
	...
	public:
		...
		*/
		 ...
		 * \param i index of the dof. This class has a template argument specifying the number of dofs per sector. This argument has to be less or equal.
		 * \param z this is a relative value for interpolation with \f$z \in [0,1]\f$. If \f$z = 0\f$ the values for the lower end of the sector are returned. If \f$z=1\f$ the values for the upper end of the sector are returned. In between the values are interpolated according to the rules for the specific dof.
		 */
