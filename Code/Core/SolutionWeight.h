 ...
 * \brief This function has internal usage to execute a function only on the interior of the Waveguide.
 *
 ...
 * Mathematically, this function can be represented by \f[ f: \mathbb{R}^{dim} \to \{1,0\} , \, \boldsymbol{x} \mapsto \begin{cases}1&\text{ for} \, \boldsymbol{x} \in \Omega_W \\ 0 &\text{ else}\end{cases}
