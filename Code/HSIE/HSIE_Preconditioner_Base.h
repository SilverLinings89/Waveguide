...
class HSIEPreconditionerBase {
  ...
  public:
    HSIEPreconditionerBase ( dealii::parallel::distributed::Triangulation<3> * in_tria);
    ~HSIEPreconditionerBase();
    void compute_number_of_dofs( int hsie_degree );
    void assemble_blocks();
    void vmult(dealii::TrilinosWrappers::MPI::BlockVector &dst, const dealii::TrilinosWrappers::MPI::BlockVector &src) const;
};
